...
- Setup a Questrade application and store the refresh token in the [`.auth-tokens`](https://github.com/vineetjohn/clojure-questrade/blob/master/.auth-tokens.json) file.
